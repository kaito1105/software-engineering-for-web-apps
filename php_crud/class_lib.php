...
class lib
{
    ...
    */
    static function menu_from_assoc_array($name, &$array, $dummy_option = '', $selected = '', $multiple = '', $required = '', $event_handler = '')
    {
        ...
        $menu = "<select name=\"$name\" id=\"$id\" $multiple $required $event_handler >\n";
